...
export class BuildTile {
   ...
   // -----------
    ...
    _applyBuildItem(conf) {
        ...
        this.ta.colorSquare({x:this.x, y:this.y, size:1, color:c})
        this.ta.itemForceKey({x:this.x, y:this.y, assetKey:conf.key})
    ...
    */
    ...
    filterChoiseNearTile(buildTileList, useAdvance) {
        ...
        if (pickedItemConf) {
            ...
            this.ta.colorSquare({x:this.x, y:this.y, size:1, color:[255, 0, 0]})

...
export class WcBuildConf_House3a extends AbstractWcBuildConf {
    constructor(conf={}) {
        super(conf)
            ...
            /// A - 0 
            {
                ...
                items: [
                    {weight: 4, color: [0, 0, 0], h:1, allowMove:false, isFrise: true, functions: [
                        ...
                        {h:2, key: this.ROOF_PREFIX + "CornerInner", keyR:3, sufix:this.ROOF_SUFFIX },
                    ]},
                ...
                items: [
                    { weight: 0, color: [0, 0, 0], allowMove:false, isFrise: true, functions: [
                        ...
                        {h:2, key: this.ROOF_PREFIX + "", keyR:3, sufix:this.ROOF_SUFFIX },
                        {h:1, key: this.WALL_PREFIX + "WindowGlass", keyR:1, sufix:this.WALL_SUFFIX },
                ...
                items: [
                    ...
                    { weight: 4, color: [0, 0, 0], allowMove:false, isFrise: true,  functions: [
                        ...
                        {h:2, key: this.ROOF_PREFIX + "Window", keyR:3, sufix:this.ROOF_SUFFIX },
                        {h:1, key: this.WALL_PREFIX + "WindowGlass", keyR:1, sufix:this.WALL_SUFFIX },
                        {h:0, key: this.WALL_PREFIX + "WindowGlass", keyR:1, sufix:this.WALL_SUFFIX },
                    ]},
            ...
            },
            {
                ...
                items: [
                    { weight: 2, color: [0, 0, 0], allowMove:false, isFrise: true, functions: [
                        ...
                        {h:3, key: this.ROOF_PREFIX + "Point", keyR:3, sufix:this.ROOF_SUFFIX },
                        {h:2, key: this.WALL_PREFIX + "Block", keyR:0, sufix:this.WALL_SUFFIX },
                    ]},
...

            {
                ...
                items: [
                    { weight: .1, color: [128, 128, 128], allowMove:false, isFrise: true, functions: [
                        ...
                        {h:2, key: this.ROOF_PREFIX + "Corner", keyR:3, sufix:this.ROOF_SUFFIX },
                        {h:1, key: this.WALL_PREFIX + "Corner", keyR:2, sufix:this.WALL_SUFFIX },
                        {h:0, key: this.WALL_PREFIX + "Corner", keyR:2, sufix:this.WALL_SUFFIX },
                    ]},
                    { weight: .1, color: [128, 128, 128], allowMove:false, isFrise: true, functions: [
                        ...actionsEmptyFlat
                    ], items:[
                        {h:2, key: this.ROOF_PREFIX + "CornerRound", keyR:3, sufix:this.ROOF_SUFFIX },
                        {h:1, key: this.WALL_PREFIX + "CornerDiagonal", keyR:2, sufix:this.WALL_SUFFIX },

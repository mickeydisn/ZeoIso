...
class Shape:
    ...
    def fromListOfLayers(layers:list[str]) -> Self:
    ...
    def fromShapeCode(shapeCode:str) -> Self:
...
def coreCut(shape:Shape) -> list[Shape]:
...
def rot(shape:Shape) -> list[Shape]:
    rotate90CW(shape)

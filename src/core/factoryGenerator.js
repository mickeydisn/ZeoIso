...
function FactoryGenerator(world) {

  this.seed = "mickey";
  this.items = world.myGApi.items;
  this.biomes = world.myGApi.biomesFactory.biomes;
  this.biomeSelectMatrix = world.myGApi.biomeMatrix;

  this.biomeSelectMatrix = [
    "-9", "-9", "-9", "-7", "-8", "-10", "-10", "-10",
    "-9", "-9", "-7", "-7", "-8", "-8",  "-10", "-10", 
    "-3", "-5", "-5", "-5", "-6", "-6",  "-6",  "-4", 
    "-3", "-3", "-3", "-1", "-2", "-4",  "-4",  "-4", 
...
FactoryGenerator.prototype = {
  ...
  _noise : function (x=0, y=0) {
      var f0 = 1 / 4 / 16;
      return (this.simplex.noise2D(f0 * x, f0 * y) + 1) / 2;
  },

  _zoom_and_grain: function (x, y, zoom, grain){
    x = zoom * x ;
    y = zoom * y ;
  ...
  getRawLvl : function(x, y, zoom=1, grain=1) {    
    var fw = 1/ 200;
    var fa = 1/ 20;
    var f0 = 1/ 8;
    var f1 = 2/ 3;
  ...
  getLvl : function(x, y, zoom=1, grain=1) {    
    lvl = this.getRawLvl(x, y, zoom, grain)
    return lvl * 256 & 0xFF;
  },

  getTemperature : function(x, y, zoom=1, grain=1) {
    var f = 0.5 / 2 
    var t = 42 
    var f0 = f * 1/ 20 / 2
    var f1 = f * 1/ 10 / 2
  ...
  getHydro : function(x, y, zoom=1, grain=1) {
    var f = 0.5 / 2
    var t = 0 
    var f0 = 1/ 20 / 2
    var f1 = 1/ 10 / 2
  ...
  getFlore : function(x, y, t=0, zoom=1, grain=1) {
    grain = grain * 2;
    var f0 = 1/15;
    // var f1 = 0.1;
    var f2 = 0.75;
  ...
  getRawDensity : function (x, y, zoom=1, grain=1) {
    var f0 = 1/40;
    var f1 = 1/10;
    var f2 = 1/2;
    var t = 0;
  ...
  getDensity : function (x, y, zoom=1, grain=1) {
  ...
  getBiome: function (x, y, zoom=1, grain=1) {
    ...
    return this.biomes[this.biomeSelectMatrix[temp * 8 + hydro]];
  },


  getItem: function(x, y, zoom=1, grain=1) {
    ...
    if (floreItem == null)
      return null;
    return this.items[floreItem];
  },

  /* ----------- */

  getBiomeColor : function(x, y, lvl=0, zoom=1, grain=1) {
    return this.getBiome(x, y, zoom, grain).color(lvl); 
  },

  getLvlColor : function (x, y, zoom=1, grain=1) {
